...
if($cart = isset($_POST["submit"]) ? $_POST["submit"] : ""){
  if($cart == "add to cart"){
    $gender   = isset($_POST["gender"]) ? $_POST["gender"] : "";
    $wetsuit  = isset($_POST["wetsuitType"]) ? $_POST["wetsuitType"] : "";
    //$layer1   = isset($_POST["shoulderLayer1"]) ? $_POST["shoulderLayer1"] : "";
    //$layer2   = isset($_POST["shoulderLayer2"]) ? $_POST["shoulderLayer2"] : "";
    //$layer3   = isset($_POST["shoulderLayer3"]) ? $_POST["shoulderLayer3"] : "";
    ...
    if($id_member != $loggedin["id_member"]){
      echo "<script language='JavaScript'>
                    alert('Save your custom image first');
                    location.href = 'index.php';
                  </script>";
    } else {
      $sql = "update `custom_cart` set  `gender` = '$gender', `wet_suit_type` = '$wetsuit' , `arm_zipper` = '$armZipper' , `ankle_zipper` = '$ankleZipper' where id_member='".$loggedin["id_member"]."'";

            mysql_query($sql) or die(mysql_error());
            echo "<script language='JavaScript'>
                    alert('Succesfully adding to your custom cart');
                    location.href = 'custom_cart.php';
                  </script>";
    }
            ...
            <div class="form-group">
                ...
                <div>
                      ...
                      <div class="color" active style="background-color: #1f1f24;"></div>
                                                          ...
                                                          <a href="javascript:void(0);" onclick="change_colors('var0', 'blue', this);" title="Blue">
                ...
                <div>
                      ...
                      <div class="color" active style="background-color: #1f1f24;"></div>
                                                          ...
                                                          <a href="javascript:void(0);" onclick="change_colors('var1', 'blue', this);" title="Blue">
                      <div class="color " style="background-color: #345aa0;"></div>
                    </a>
              ...
              <div id="custom-female" class="row custom-gender" style="display: none;">
                <div class="col-sm-12">
                  <div class="wetsuit-box">
                    ...
                    <img class="var0-var0" id="var3" src="public/custom/wetsuit/female-new/var0/var0/black.png" alt="">
                    <img class="var1-var1" id="var4" src="public/custom/wetsuit/female-new/var1/var1/black.png" alt="">
                    <img class="var2-var2" id="var5" src="public/custom/wetsuit/female-new/var2/var2/black.png" alt="">
              ...
              <div id="custom-unisex" class="row custom-gender" style="display: none;">
                <div class="col-sm-12">
                  <div class="wetsuit-box">
                    ...
                    <img class="var0-var0" id="var6" src="public/custom/wetsuit/unisex_new/var0/var0/black.png" alt="">
                    <img class="var1-var1" id="var7" src="public/custom/wetsuit/unisex_new/var1/var1/black.png" alt="">
            ...
            <div class="text-center form-group" style="margin-top: 20px;">
              ...
              <?php 
                if($_SESSION['user'] == ''){
                  ...
                  echo '
                  <input type="submit" class="btn btn-default text-center" name="submit" value="add to cart"> 
  ...
  function draw_female(){
    ...
    function imageLoaded(){
      if(++loaded == 3){
        ...
        Marvin.combineByAlpha(image, image3, image, 0, 0);
        image.draw(canvas2);
        var canvas2Data = canvas2.toDataURL("image/png" , 0.2);
      }
    }
  }
  ...
  function draw_unisex(){
    ...
    function imageLoaded(){
      if(++loaded == 3){
        ...
        Marvin.combineByAlpha(image, image3, image, 0, 0);
        image.draw(canvas3);
        var canvas3Data = canvas3.toDataURL("image/png" , 0.2);
      }
    }
  }
