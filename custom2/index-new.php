  ...
  <body id="bd" class="cms-index-index4 header-style4 prd-detail cms-simen-home-page-v2 default cmspage">
    <div id="sns_wrapper">  
      ...
      <div id="sns_header" class="wrap" style="margin-bottom: 0;">
        <!-- Header Top -->
        <div class="sns_header_top hidden-xs clearfix">
      ...
      <div id="sns_header_logo" class="hidden-xs" style="background-color: #FFF;">
        <div class="container">
          <div class="container_in">
            <div class="row">
              <div class="col-sm-12 text-center" style="margin-top: 5px; margin-bottom: 20px;">
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="sns_menu" class="" style="margin-top:0;">
        <div class="container" style="width: 100%; margin-left: 0; margin-right: 0; padding-left:0; padding-right: 0;">
          <div class="sns_mainmenu clearfix">
            <div id="sns_mainnav" class="pull-left" style="margin-left: 10px;">
              <div id="sns_custommenu" class="visible-md visible-lg">
                <ul class="mainnav">
                  <li class="level0 image-follow" style="display: none;">
                    <a class="menu-title-lv0 pd-menu116" href="/en">
            ...
            <div class="sns_menu_right pull-right " id="cart-header" style="margin-right: 10px;">
              <div class="top-cart hidden-xs">
  <div class="mycart mini-cart" style="padding-right: 16px;">
    
  </div>
</div>
            </div>
            <div class="sns_menu_right pull-right" style="margin-top: 10px; margin-right: 10px;">
              
            </div>
            <div id="scroll-language" class="sns_menu_right pull-right" style="margin-top: 10px; margin-right: 10px; display: none;">
              <form action="/en/languageChange/" method="post">
                <select name="languageSelector" class="form-control input-sm" onchange="change_language(this);">
                  <option value="en">Language (EN)</option>
                                      <option value="en">English (en)</option>
                                  </select>
                <input type="hidden" name="returnRedirect" value="custom">
              </form>
            </div>
          </div>
        </div>
...
<form action="/en/cart/addCustom" method="post">
          ...
          <div class="col-sm-2 custom-box">
            ...
            <div class="form-group">
              ...
              <select name="wetsuitType" class="form-control" onchange="change_suit_type(this.value);">
                <option value="front">Front Zipper</option>
                <option value="back" selected>Back Zipper</option>
              </select>
            </div>
                          <div class="form-group">
                ...
                <div>
                      ...
                      <div class="color " style="background-color: #538f75;"></div>
                                                          ...
                                                          <a href="javascript:void(0);" onclick="change_colors('var1' ,'light_blue', this);" title="Light Blue">
                      ...
                      <div class="color " style="background-color: #2b335a;"></div>
                                                          ...
                                                          <a href="javascript:void(0);" onclick="change_colors('var1' ,'tangerine_1', this);" title="Tangerine 1">
                      ...
                      <div class="color " style="background-color: #ffffff;"></div>
                                                          ...
                                                          <a href="javascript:void(0);" onclick="change_colors('var1' ,'tangerine_2', this);" title="Tangerine 2">
                      <div class="color " style="background-color: #ee6545;"></div>
                    </a>
                                                      </div>
              </div>
                          <div class="form-group">
                <label>2<sup>st</sup> Layer</label>
                ...
                <div>
                      ...
                      <div class="color " style="background-color: #538f75;"></div>
                                                          ...
                                                          <a href="javascript:void(0);" onclick="change_colors('var2' ,'light_blue', this);" title="Light Blue">
                      <div class="color " style="background-color: #4475a8;"></div>
                    </a>
                      ...
                      <div class="color " style="background-color: #2b335a;"></div>
                                                          ...
                                                          <a href="javascript:void(0);" onclick="change_colors('var2' ,'tangerine1', this);" title="Tangerine 1">
                      <div class="color " style="background-color: #ff7143;"></div>
                    </a>
                                                          <a href="javascript:void(0);" onclick="change_colors('var2' ,'white', this);" title="White">
                      <div class="color " style="background-color: #ffffff;"></div>
                    </a>
                                                          <a href="javascript:void(0);" onclick="change_colors('var2' ,'tangerine2', this);" title="Tangerine 2">
                      <div class="color " style="background-color: #ee6545;"></div>
                    </a>
                                                      </div>
              </div>
  ...
  <div>
          <a href="javascript:void(0);" onclick="change_color('hand_pad', 'black', this);" title="Black">
        <div class="color" style="background-color: #1f1f24;"></div>
      </a>
          <a href="javascript:void(0);" onclick="change_color('hand_pad', 'blue', this);" title="Blue">
        <div class="color" style="background-color: #345aa0;"></div>
      </a>
          <a href="javascript:void(0);" onclick="change_color('hand_pad', 'white', this);" title="White">
        <div class="color" style="background-color: #ffffff;"></div>
      </a>
        <a href="javascript:void(0);" onclick="change_color('hand_pad', '', this);" title="none">
...
<div class="form-group">
  ...
  <div>
          <a href="javascript:void(0);" onclick="change_color('knee_pad', 'black', this);" title="Black">
        <div class="color" style="background-color: #1f1f24;"></div>
      </a>
          <a href="javascript:void(0);" onclick="change_color('knee_pad', 'blue', this);" title="Blue">
        <div class="color" style="background-color: #345aa0;"></div>
      </a>
          <a href="javascript:void(0);" onclick="change_color('knee_pad', 'white', this);" title="White">
        <div class="color" style="background-color: #ffffff;"></div>
      </a>
        <a href="javascript:void(0);" onclick="change_color('knee_pad', '', this);" title="none">
      <div class="color active" style="background-image: url('public/images/sakarioka/x.jpg')"></div>
    </a>
  </div>
</div>
<div class="form-group">
  ...
  <div>
              <a href="javascript:void(0);" onclick="change_color('thread', 'black', this);" title="Black">
        <div class="color " style="background-color: #1f1f24;"></div>
      </a>
                <a href="javascript:void(0);" onclick="change_color('thread', 'blue', this);" title="Blue">
        <div class="color " style="background-color: #345aa0;"></div>
      </a>
                <a href="javascript:void(0);" onclick="change_color('thread', 'white', this);" title="White">
...
<div class="form-group">
  ...
  <select name="genitalZipper" class="form-control" onchange="change_genital_zipper(this.value);">
            ...
            <div id="custom-change">
              ...
              <div id="custom-male" class="row custom-gender" style="display: none;">
               <div class="col-sm-12">
                  <div class="wetsuit-box">
                    ...
                    <img class="var1-var1" src="public/custom/wetsuit/female-new/var1/var1/black.png" alt="">
                    <img class="var2-var2" src="public/custom/wetsuit/female-new/var2/var2/black.png" alt="">
                    <img class="var1-thread" src="public/custom/wetsuit/female-new/thread/white.png" alt="">
                    <img class="var1-hand_pad" src="" alt="">
                    <img class="var1-knee_pad" src="" alt="">
                    <img class="side-front_zip" src="public/custom/wetsuit/female-new/front_zip.png" alt="" style="display: none;">
              ...
              <div id="custom-female" class="row custom-gender" style="display: none;">
                <div class="col-sm-12">
                  <div class="wetsuit-box">
                    ...
                    <img class="var1-var1" src="public/custom/wetsuit/female-new/var1/var1/black.png" alt="">
                    <img class="var2-var2" src="public/custom/wetsuit/female-new/var2/var2/black.png" alt="">
                    <img class="side-thread" src="public/custom/wetsuit/female-new/thread/white.png" alt="">
                    <img class="side-hand_pad" src="" alt="">
                    <img class="side-knee_pad" src="" alt="">
                    <img class="side-front_zip" src="public/custom/wetsuit/female-new/front_zip.png" alt="" style="display: none;">
                    <img class="side-hand_zip" src="public/custom/wetsuit/female-new/hand_zip.png" alt="" style="display: none;">
                    <img class="side-leg_zip" src="public/custom/wetsuit/female-new/leg_zip.png" alt="" style="display: none;">
                    <img src="public/custom/wetsuit/female-new/neck_line.png" alt="">
              ...
              <div id="custom-unisex" class="row custom-gender" style="display: none;">
                <div class="col-sm-12">
                  <div class="wetsuit-box">
                    <img src="public/custom/wetsuit/female-new/default.png" alt="">
                    <img class="var1" src="public/custom/wetsuit/female-new/var1/var1/black.png" alt="">
                    <img class="var2" src="public/custom/wetsuit/female-new/var2/var2/black.png" alt="">
                    <img class="side-thread" src="public/custom/wetsuit/female-new/thread/white.png" alt="">
                    <img class="side-knee_pad" src="" alt="">
                    <img class="side-front_zip" src="public/custom/wetsuit/female-new/front_zip.png" alt="" style="display: none;">
                    <img class="side-hand_zip" src="public/custom/wetsuit/female-new/hand_zip.png" alt="" style="display: none;">
...
<script>
  ...
  {
    $('#custom-male').find('.var1-' + layer).attr('src', 'public/custom/wetsuit/female-new/var1/' + layer + '/'  + color + '.png');
    $('#custom-male').find('.var2-' + layer).attr('src', 'public/custom/wetsuit/female-new/var2/' + layer + '/' + color + '.png');
    //$('#custom-male').find('.front-' + layer).attr('src', 'public/custom/wetsuit/male/front/' + layer + '/' + color + '.png');

    //$('#custom-female').find('.var1').attr('src', 'public/custom/wetsuit/female-new/var1/' + color + '.png');
    //$('#custom-female').find('.var2').attr('src', 'public/custom/wetsuit/female-new/var2/' + color + '.png');
    //$('#custom-female').find('.front-' + layer).attr('src', 'public/custom/wetsuit/female/front/' + layer + '/' + color + '.png');
  ...
  {
    if (suitType == 'front') {
      $('#custom-male').find('.back-back_zip').hide();
      $('#custom-male').find('.front-front_zip').show();
      $('#custom-male').find('.side-front_zip').show();

      $('#custom-female').find('.back-back_zip').hide();
      $('#custom-female').find('.front-front_zip').show();
      $('#custom-female').find('.side-front_zip').show();

      $('#custom-unisex').find('.back-back_zip').hide();
      $('#custom-unisex').find('.front-front_zip').show();
      $('#custom-unisex').find('.side-front_zip').show();
    } else {
      $('#custom-male').find('.back-back_zip').show();
      $('#custom-male').find('.front-front_zip').hide();
      $('#custom-male').find('.side-front_zip').hide();

      $('#custom-female').find('.back-back_zip').show();
      $('#custom-female').find('.front-front_zip').hide();
      $('#custom-female').find('.side-front_zip').hide();

      $('#custom-unisex').find('.back-back_zip').show();
      $('#custom-unisex').find('.front-front_zip').hide();
