...
if ($loggedin = logged_inadmin()) { // Check if they are logged in
                    ...
                    <div class=" container    container-fixed-lg">
                        ...
                        <div class="card card-transparent">
                            <div class="card-header ">
                                <div class="card-title">List Categories</div>
                                <div class="pull-right">
                                    <div class="col-xs-12">
                                        <a href="form_category.php" id="show-modal" class="btn btn-primary btn-cons" style="color:white"><i class="fa fa-plus"></i> Add Category
                                        </a>
                                    </div>
                                </div>
    ...
    $sql_caregory = mysql_query("SELECT * FROM `category` WHERE `id_parent` = '0' AND `level` = '0' ORDER BY `id_cat` DESC LIMIT $start,$perhalaman ;");
                                    ...
                                    <form action="" method="post" name="list_category">
                                        <tr>
                                            <td class="v-align-middle">
                                                ' . $row_category["id_cat"] . '
                                                <input type="hidden" name="id_cate" value="' . $row_category["id_cat"] . '">
                                            </td>
                                            <td class="v-align-middle">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="form_category.php?id=' . $row_category["id_cat"] . '" type="button" class="btn btn-success"><i class="fa fa-pencil"></i></a>
