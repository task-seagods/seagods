...
<div class=" container    container-fixed-lg">
            ...
            <div class="card card-transparent">
              <div class="card-header ">
                <div class="card-title">List Sub Categories 
                </div>
                <div class="pull-right">
                  <div class="col-xs-12">
                    <a href="form_sub_category.php" id="show-modal" class="btn btn-primary btn-cons" style="color:white"><i class="fa fa-plus"></i> Add Sub Category
                    </a>
                  </div>
                </div>
          ...
          <td class="v-align-middle">
            ...
            <td>
            <div class="btn-group">
                          <a href="form_sub_category.php?id='.$row_sub_category["id_cat"].'" type="button" class="btn btn-success"><i class="fa fa-pencil"></i>
                          </a>
