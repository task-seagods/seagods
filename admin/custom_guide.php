...
if(isset($_POST['submit'])){
    $custom_guide   = mysql_real_escape_string($_POST['custom_guide']);

    $input = mysql_query("update pages set custom ='$custom_guide'");

    if($input){
        
            echo "  <script> alert ('successfully updated') 
                window.location.href='custom_guide.php'
                </script>";
        }else {
        ...
        <div class="content ">
            ...
            <div class="card card-default">
              ...
              <div class="card-block no-scroll card-toolbar">
                <h5>Custom Guide Page</h5>
                <div class="summernote-wrapper">
                  <form method="post" action="custom_guide.php">
                  <textarea id="summernote" name="custom_guide">'.$text.'</textarea>
                </div>
              </div>
            </div>
