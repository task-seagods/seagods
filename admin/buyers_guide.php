...
if(isset($_POST['submit'])){
    $buyers_guide   = mysql_real_escape_string($_POST['buyers_guide']);

    $input = mysql_query("update pages set buyer ='$buyers_guide'");

    if($input){
        
            echo "  <script> alert ('successfully updated') 
                window.location.href='buyers_guide.php'
                </script>";
        }else {
...
$titlebar ="Buyers Guide";
$titlepage="Buyers Guide";
$menu="";
        ...
        <div class="content ">
            ...
            <div class="card card-default">
              ...
              <div class="card-block no-scroll card-toolbar">
                <h5>Buyers Guide Page</h5>
                <div class="summernote-wrapper">
                  <form method="post" action="buyers_guide.php">
                  <textarea id="summernote" name="buyers_guide">'.$text.'</textarea>
                </div>
              </div>
            </div>
