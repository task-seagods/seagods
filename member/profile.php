...
if($simpan == "account"){
  ...
  $query_m = "UPDATE `member` set `nama_pengguna` = '$username' , `firstname` = '$firstname' , `lastname` = '$lastname'
...
$add = isset($_POST["alamat"]) ? $_POST["alamat"] : '';
...
<div class=" container    container-fixed-lg">
            ...
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                ...
                <li class="nav-item">
                  <a class="" data-toggle="tab" href="#tab4" role="tab"><i class="fa fa-check tab-icon"></i> <span>Rec</span></a>
                </li>
              </ul>
              <!-- Tab panes -->
                      ...
                      <div class="padding-30 sm-padding-5">
                          ...
                          <div class="form-group-attached">
                            <div class="form-group form-group-default ">
                              ...
                              <span>'.$row_member['username'].'</span>
                            </div>
                            <div class="row clearfix">
                              <div class="col-sm-6">
                                <div class="form-group form-group-default">
                                  <label>First Name</label>
                                  <span>'.$row_member['firstname'].'</span>
                                </div>
                              </div>
                              <div class="col-sm-6">
                                <div class="form-group form-group-default">
                                  <label>Last name</label>
                                  <span>'.$row_member['lastname'].'</span>
                                </div>
                              </div>
                            </div>
                            <div class="form-group form-group-default ">
                              <label>Email</label>
                              <span>'.$row_member['email'].'</span>
                            </div>
              <div class="form-group form-group-default ">
                              <label>Phone Number</label>
                              <span>'.$row_member['notelp'].'</span>
                            </div>
                            <div class="form-group form-group-default ">
                              <label>Bio</label>
                              <span>'.$row_member['bio'].'</span>
                            </div>
                          </div>
                      </div>
                    </div>
              ...
              <div class="form-group form-group-default ">
                          ...
                          <br>
                          <button type="submit" class="btn btn-default btn-cons" name="submit" value="account" >Submit</button>
                      </form>
                      </div>
                    </div>
                  </div>
              ...
              <div class="form-group form-group-default ">
                          ...
                          <br>
                          <button type="submit" class="btn btn-default btn-cons" name="password" value="password">Change</button>
                          </form>   
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row row-same-height">
                    <div class="col-md-5 b-r b-dashed b-grey ">
                      <div class="padding-30 sm-padding-5 sm-m-t-15 m-t-50">
                        ...
                        <table class="table table-condensed">
                            ...
                            <tr>
                                <td class=" col-md-9">
                                  <span class="m-l-10 font-montserrat fs-11 all-caps">Alamat</span>
                                </td>
                              ...
                              <tr>
                                <td colspan="2" class=" col-md-3 text-right">
                                  <h4 class="text-primary no-margin font-montserrat">'.$row_member['alamat'].'</h4>
                    ...
                    <div class="col-md-7">
                      <div class="padding-30 sm-padding-5">
                          ...
                          <br>
                          <button type="submit" class="btn btn-default btn-cons" name="alamat" value="alamat">Update</button>
                          </form>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-5 b-r b-dashed b-grey ">
                      <div class="padding-30 sm-padding-5 sm-m-t-15 m-t-50">
                        ...
                        <table class="table table-condensed">
                            ...
                            <tr>
                                <td class=" col-md-9">
                                  <span class="m-l-10 font-montserrat fs-11 all-caps">No Rec</span>
                                </td>
                                <td class=" col-md-3 text-right">
                                  <span>#</span>
                                </td>
                              ...
                              <tr>
                                <td colspan="2" class=" col-md-3 text-right">
                                  <h4 class="text-primary no-margin font-montserrat"></h4>
                    ...
                    <div class="col-md-7">
                      <div class="padding-30 sm-padding-5">
                          ...
                          <div class="form-group-attached">
                            ...
                            <div class="form-group form-group-default ">
                              <label>Rec</label>
                              <textarea name="rec" class="form-control"></textarea>
                            </div>
                          </div>
                          <br>
                          <input type="submit" class="btn btn-default btn-cons" name="rec">
                          </form>
                      </div>
                    </div>
                  </div>
