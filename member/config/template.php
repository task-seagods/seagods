...
$menu = '
        <div class="menu-bar header-sm-height" data-pages-init=\'horizontal-menu\' data-hide-extra-li="0">
          ...
          <ul>
            ...
            <li>
              <a href="profile.php"><span class="title">Profile</span></a>
            </li>
            
            
            <li class="">
                  <a href="list-transaction.php">List Transaction</a>
            </li>
            <li>
              <a href="wishlist.php"><span class="title">Wishlist</span></a>
            </li>
            <li>
              <a href="customemade.php"><span class="title">Custom Made</span></a>
            </li>
            <li>
...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>'.$titlebar.' SeaGods Member Page</title>
        ...
        <div class="header-inner header-md-height">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="pull-left p-r-10 fs-14 font-heading hidden-md-down">
              <span class="semi-bold">Member</span> <span class="">'.$user.'</span>
            </div>
